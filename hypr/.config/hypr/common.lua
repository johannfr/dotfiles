...
local menu = "rofi -modi 'run,drun' a-show run -show run -show-icons"
...
hl.on("hyprland.start", function()
	hl.exec_cmd("kanshi")
	hl.exec_cmd(home .. "/bin/waybar-loop.sh")
...
-- Named workspaces for I, O, P
hl.workspace_rule({ workspace = "11", default_name = "I" })
hl.workspace_rule({ workspace = "12", default_name = "O" })
hl.workspace_rule({ workspace = "13", default_name = "P" })
...
local ctrlMainMod = "CTRL + " .. mainMod
local shiftMainMod = "SHIFT + " .. mainMod
...
-- Zup should be floating
hl.window_rule({
	name = "zup-floating",
	match = { title = "^Log Work$" },
	float = true,
})

-- Auto-assign chat apps to workspace I
hl.window_rule({
	name = "chat-to-workspace-I",
	match = { class = "^(google-chat-linux|signal|org.telegram.desktop)$" },
	workspace = "name:I silent",
})

-- Auto-assign email apps to workspace O
hl.window_rule({
	name = "email-to-workspace-O",
	match = { class = "^(thunderbird|chrome-mail.google.com__mail_y_johann@tern.is-Default)$" },
	workspace = "name:O silent",
})

-- Auto-assign Spotify to workspace P
hl.window_rule({
	name = "spotify-to-workspace-P",
	match = { class = "^(Spotify)$" },
	workspace = "name:P silent",
})
